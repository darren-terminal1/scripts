...
# WORKSTATION:
# Libraries
sudo apt install -y libapt-pkg-perl libavahi-compat-libdnssd1 libqt5core5a libqt5gui5 libqt5network5 libqt5widgets5 libavahi-compat-libdnssd1 libjpeg62 beignet-opencl-icd libopenal1 libopenal-data libopenal-dev python3-launchpadlib python3-testresources
# Applications
